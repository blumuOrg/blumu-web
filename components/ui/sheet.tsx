...
const sheetSidePositionClasses: Record<
  NonNullable<SheetContentProps["side"]>,
  string
> = {
  top: cn(
    "top-4 right-auto bottom-auto left-1/2 h-auto w-[calc(100%-2rem)] max-w-md -translate-x-1/2 rounded-2xl border",
    "data-ending-style:-translate-x-1/2 data-starting-style:-translate-x-1/2",
    "data-ending-style:translate-y-0 data-starting-style:-translate-y-2"
  ),
  right:
